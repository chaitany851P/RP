...
class FallDetector:
    def __init__(self):
        if YOLO_AVAILABLE and os.path.exists(YOLO_MODEL_PATH):
            ...
            self.yolo = None
            self.use_yolo = False
            print("[FallDetector] best.pt not found — using MediaPipe fallback")
    ...
    def _pose_persons(self, frame):
        ...
        for lm in result.pose_landmarks:
            ...
            # ← Both conditions must be true: body horizontal AND spine tilted
            fallen = (
